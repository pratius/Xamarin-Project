...
namespace SloperMobile.Common.Constants
{
    public class AppSetting
    {
        ...
        public const string APP_LABEL_DROID = "Grand Valley Climbing";

        //Guest DNN Login
        public const string Guest_UserId = "gvc.guest@sloperclimbing.com";
        public const string Guest_UserPassword = "+RC_NeFv3YZJYch$";
    }
}
