...
namespace SloperMobile.ViewModel
{
    public class TopoMapRoutesViewModel : BaseViewModel
    {
        ...
        public Action<PointWithId> PointTapped { get; set; }
        ...
        public Command<PointWithId> CanvasTappedCommand
        {
            get
            {
                return new Command<PointWithId>((p) => OnCanvasTapped(p));
            }
        }

        public void OnCanvasTapped(PointWithId p)
        {
