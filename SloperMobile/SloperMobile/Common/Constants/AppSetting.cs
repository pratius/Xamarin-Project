...
namespace SloperMobile.Common.Constants
{
    public class AppSetting
    {
        ...
        //Company
        public const string APP_TITLE = "URBAN CLIMB";         public const string APP_COMPANY = "Urban Climb";         public const string APP_DBNAME = "sloper" + APP_ID + ".db3";

        //Guest DNN Login
        public const string Guest_UserId = "urbanclimb.guest@sloperclimbing.com";         public const string Guest_UserPassword = "$KG!je,L4uJ8U8}!";
    }
}
